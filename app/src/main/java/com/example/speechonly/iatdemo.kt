...
import java.util.*
class iatdemo : AppCompatActivity(), View.OnClickListener {
    // 语音听写对象
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mSharedPreferences = getSharedPreferences(
            IatSettings.IatFragment.PREFER_NAME,
     ...
     * 获取联系人监听器。
     */
    private val mContactListener = ContactManager.ContactListener { contactInfos, changeFlag ->
